...
class ComputerSecondLogic extends GetxController {
  ...
  cleanNoteData() async {
    Get.dialog(AlertDialog(
      ...
      content: const Text('Do you want to clean note records?'),
      actions: [
        TextButton(
          onPressed: () {
            Get.back();
  ...
  aboutComputerPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutComuterUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with the calculations you need for your building"""),
      ],
      context: context,
    );
  }
